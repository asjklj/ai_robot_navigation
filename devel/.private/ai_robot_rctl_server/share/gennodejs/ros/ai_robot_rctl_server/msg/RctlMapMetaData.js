...
// (in-package ai_robot_rctl_server.msg)
...
class RctlMapMetaData {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('data')) {
        ...
        this.data = new nav_msgs.msg.MapMetaData();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = nav_msgs.msg.MapMetaData.serialize(obj.data, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new RctlMapMetaData(null);
    // Deserialize message field [name]
    data.name = std_msgs.msg.String.deserialize(buffer, bufferOffset);
    // Deserialize message field [data]
    data.data = nav_msgs.msg.MapMetaData.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new RctlMapMetaData(null);
    ...
    if (msg.data !== undefined) {
      resolved.data = nav_msgs.msg.MapMetaData.Resolve(msg.data)
    }
    else {
      resolved.data = new nav_msgs.msg.MapMetaData()
    }
...
module.exports = RctlMapMetaData;
